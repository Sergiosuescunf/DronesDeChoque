...
def EstablecerMarcas():
    ...
    Marcas.clear()
    Marcas.append((-17.5, 15))
    Marcas.append((-17.5, 0))
    Marcas.append((-30, -2.5))
    Marcas.append((-32.5, 10))
    Marcas.append((-40, 12.5))
    Marcas.append((-42.5, -10))
    Marcas.append((-20, -12.5))
    Marcas.append((-17.5, -20))
    Marcas.append((-10, -22.5))
    Marcas.append((-7.5, -10))
    Marcas.append((0, -7.5))
    Marcas.append((2.5, 0))
    Marcas.append((-5, 2.5))
    Marcas.append((-7.5, 10))
    ...
    Marcas.append((5, -17.5))
    Marcas.append((2.5, -30))
    Marcas.append((-25, -32.5))
    Marcas.append((-27.5, -25))
    Marcas.append((-40, -22.5))
    Marcas.append((-42.5, -40))
    Marcas.append((2.5, -42.5))
    Marcas.append((5, -42.5))
...
def CalcularSector(x, z, sector):
    ...
    if(distFinal + distInicio > SectorDist[sector] + 10):
        auxChocado = 0
...
def Entrenar():
    ...
    env = UnityEnvironment(file_name="CircuitoEntreno", seed=1, side_channels=[])
    env.reset()
